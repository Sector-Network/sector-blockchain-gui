...
import { Card, FormatLargeNumber, Link, Loading, TooltipIcon, Flex } from '@sector/core';
import {
  unix_to_short_date,
  hex_to_array,
  arr_to_hex,
...
export default function Block() {
  ...
  const baseFarmerReward = octet_to_sector(calculateBaseFarmerReward(blockRecord.height));
  ...
  const rows = [
    ...
    },
    {
      ...
      value: (
        <Link target="_blank" href={`https://www.sectorexplorer.com/blockchain/puzzlehash/${blockRecord.farmer_puzzle_hash}`}>
    ...
    },
    {
      ...
      value: (
        <Link target="_blank" href={`https://www.sectorexplorer.com/blockchain/puzzlehash/${blockRecord.pool_puzzle_hash}`}>
    ...
    >
      <Card
        title={(
          <BlockTitle>
            <Trans>
              Block at height {blockRecord.height} in the Sector
              blockchain
            </Trans>
          </BlockTitle>
        )}

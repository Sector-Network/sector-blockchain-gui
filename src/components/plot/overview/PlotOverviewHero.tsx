...
import { PlotHero as PlotHeroIcon } from '@sector/icons';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link target="_blank" href="https://github.com/Sector-Network/sector-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button

...
import { CardStep, ConfirmDialog, Link, Select, StateColor } from '@sector/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Sector-Network/sector-blockchain/wiki/k-sizes">Learn more</Link>
        </Trans>
      </Typography>

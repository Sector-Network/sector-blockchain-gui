...
import { Card, CopyToClipboard, Flex, Table } from '@sector/core';
import type { RootState } from '../../modules/rootReducer';
import type { Row } from '../core/components/Table/Table';
import { octet_to_sector_string, octet_to_colouredcoin_string } from '../../util/sector';
...
const getCols = (type: WalletType) => [
  ...
  },
  {
    field: (row: Row) => type === WalletType.COLOURED_COIN
      ? octet_to_colouredcoin_string(row.amount)
      : octet_to_sector_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => octet_to_sector_string(row.fee_amount),
